...
const HowitWorks = () => {
    ...
    useGSAP(() => {
        ...
        // Ensuring elements fade in smoothly
        animatewithGsap('.g_fadeIn', {
            opacity: 1,
            ease: 'power2.inOut',
            y: 0,
            duration: 1,
            stagger: 0.2 // Staggered effect for a smoother transition
        });
    });
            ...
            <div className="screen-max-width">
                ...
                <div className="mt-10 md:mt-20 mb-14 flex flex-col items-center justify-center">
                    <div className="relative w-full max-w-2xl aspect-[16/9] md:aspect-auto">
                        ...
                        <div className="absolute inset-0 flex justify-center items-center w-full h-full overflow-hidden rounded-[56px]">
                            <video
                                className="pointer-events-none absolute w-full h-full object-cover rounded-[40px] scale-[0.98]"
                                playsInline
                                preload="none"
                                muted
                                autoPlay
